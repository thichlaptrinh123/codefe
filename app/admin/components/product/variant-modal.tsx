// app/admin/components/product/variant-modal.tsx
...
export default function VariantModal({
  ...
  //   toast.error("Bạn phải nhập ít nhất Size hoặc Màu");
  //   return;
  // }

  // if (!form.price || !form.stock_quantity || !form.id_product) {
  //   toast.error("Vui lòng nhập đầy đủ thông tin còn lại");
  //   return;
  // }
