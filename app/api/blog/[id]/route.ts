...
export async function PUT(
  ...
  try {
    ...
    // ⚠️ Nếu không gửi `images`, giữ nguyên ảnh cũ
    const updatedFields = {
      ...
      isHidden: typeof data.isHidden === "boolean" ? data.isHidden : existingBlog.isHidden,
      isScheduled: typeof data.isScheduled === "boolean" ? data.isScheduled : existingBlog.isScheduled,
